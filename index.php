...
<head>
    ...
    <!-- Site Metas -->
    <title>Au Pera Restaurant</title>
                        ...
                        <nav class="navbar navbar-default" id="mainNav">
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#reservation">Contactez-nous</a></li>
                                </ul>
                            </div>
                            <!-- end nav-collapse -->
                        </nav>
                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>Venez avec  <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="vous même:Toto:Steve Rogers" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
                            <h2>Restaurant Familial </h2>
                            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem nonummy nibh euismod</p>
                            <div class="book-btn">
                                <a href="#menu" class="table-btn hvr-underline-from-center">MENU</a>
                            </div>
                            <a href="#about">
                                <div class="mouse"></div>
                            </a>
    ...
    <div id="our_team" class="team-main pad-top-100 pad-bottom-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title text-center">Notre Equipe</h2>
                        <p class="title-caption text-center">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. </p>
                    </div>
                    <div class="team-box">
            ...
            <div class="row">
                <div class="form-reservations-box">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <h4 class="form-title">Contactez-Nous</h4>
                        ...
                        <form id="contact-form" method="post" class="reservations-box" name="contactform">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <input type="text" name="nom" id="form_name" class="nom" placeholder="Nom" required="required" data-error="Firstname is required.">
                                </div>
                            </div>
                            <!-- end col -->
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <input type="email" name="mail" id="email" class="mail" placeholder="E-mail" required="required" data-error="E-mail id is required.">
                                </div>
                            </div>
                            <!-- end col -->
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-box">
                                    <textarea class="message" id="msg" placeholder="Message..." name="message" maxlength="500"></textarea>
                                </div>
                            </div>
                            <!-- end col -->
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="reserve-book-btn text-center">
                                    <button class="hvr-underline-from-center" name="submit" type="submit" id="submit">Envoyer </button>
                                </div>
                            </div>
                            <!-- end col -->
                        </form>
